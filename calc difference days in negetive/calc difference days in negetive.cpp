...
short calcDifferenceInDaysForTowDatesByNegetive(sDate date1, sDate date2, bool isIncludeLastDay = false) {
    int days = 0;
    while (compareTowDate(date2, date1) == 'S')
    {
        days--;
        date2 = increaseOneDate(date2);
    }

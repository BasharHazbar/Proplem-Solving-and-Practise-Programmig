...
int main() {
    ...
    printDateDay(dateFrom, DayOfWeekOrder(dateFrom), "\n\nVacation From: ");
    printDateDay(dateTo, DayOfWeekOrder(dateTo), "\n\nVacation To: ");

    cout << "\n\nthe real vacation 1 is : " << calcDifferenceInDaysForTowDates(dateFrom, dateTo,false,true);
    cout << "\n\nthe real vacation 2 is : " << calcVacationDyas(dateFrom, dateTo);
    cout << "\n\nthe Period with include last day : " << calcDifferenceInDaysForTowDates(dateFrom, dateTo, true, false);
    cout << "\n\nthe Period with not include last day : " << calcDifferenceInDaysForTowDates(dateFrom, dateTo, false, false);

...
int main() {
    ...
    if (isLastDay(date)) {
        cout << "\n\n yes, the day is last days in month " << endl;
    }
    else {
        cout << "\n\n No, the day is not last days in month " << endl;
    }

    if (isLastMonth(date.month)) {
        cout << "\n\n yes, the month is last days in year " << endl;
    }
    else {
        cout << "\n\n No, the month is not last days in year " << endl;
    }

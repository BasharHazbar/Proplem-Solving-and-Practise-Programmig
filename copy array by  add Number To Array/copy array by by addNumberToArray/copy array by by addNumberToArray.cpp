...
void copyArrayUsingAddArrayElement(int arraySource[], int arrayDistnation[], int lenght1, int & lenght2) {
...
int main()
{
	...
	copyArrayUsingAddArrayElement(array, array2, arrLength1, arrLength2);



	printArray(array2, arrLength1);

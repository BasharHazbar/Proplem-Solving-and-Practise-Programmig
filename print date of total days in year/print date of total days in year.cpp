...
int main() {
    ...
    sDate Date = GetDateFromDayInOrderYear(numberOfDays,year);
    cout << "\n\nnumber of days from the begining of year " << year << " is:- " << numberOfDays << endl;

    cout << "\n\nDate for [" << numberOfDays << "] is " << Date.day << "/" << Date.month << "/" << Date.year;

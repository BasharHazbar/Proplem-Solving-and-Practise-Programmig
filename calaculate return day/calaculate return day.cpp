...
int main() {
    ...
    printDateDay(date, DayOfWeekOrder(date), "\n\Vacation Start Date: ");

    sDate returnDate = calcReturnVacationDate(date, vacationDays);

    printDateDay(returnDate, DayOfWeekOrder(returnDate), "\n\nReturn Date : ");

    cout << "\n\nthe real vacation 1 is : " << calcDifferenceInDaysForTowDates(date, returnDate, false, true);
    cout << "\n\nthe real vacation 2 is : " << calcVacationDyas(date, returnDate);
    cout << "\n\nthe Period with include last day : " << calcDifferenceInDaysForTowDates(date, returnDate, true, false);
    cout << "\n\nthe Period without include last day : " << calcDifferenceInDaysForTowDates(date, returnDate, false, false);
